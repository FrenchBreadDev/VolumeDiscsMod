...
import net.frenchbreadev.gsmod.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>())
                    .put(ModArmorMaterials.GILDSTONE,
                            new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 1200, 2)).build();
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if (Screen.hasShiftDown()) {
            ...
            tooltip.add(Text.literal("§9Fire Resistance III (1:00)"));
            tooltip.add(Text.literal("§9Absorption I (1:00)"));
        } else {
