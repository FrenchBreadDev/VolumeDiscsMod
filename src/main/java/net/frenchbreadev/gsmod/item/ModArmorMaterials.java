...
public enum ModArmorMaterials implements ArmorMaterial {
                ...
                GILDSTONE("gildstone", 6, new int[]{4, 7, 9, 4}, 34, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 5.5F, 0.3F, () -> {
                    return Ingredient.ofItems(new ItemConvertible[]{ModItems.GILDSTONE_INGOT});
                });
