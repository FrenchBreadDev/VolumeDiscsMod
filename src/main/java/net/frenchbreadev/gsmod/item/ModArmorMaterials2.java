...
public enum ModArmorMaterials2 implements ArmorMaterial {
                ...
                COMPRESSED_IMPEURIDIUM("compressed_impeuridium", 5, new int[]{3, 6, 8, 3}, 26, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 4.65F, 0.2F, () -> {
                    return Ingredient.ofItems(new ItemConvertible[]{ModItems.COMPRESSED_IMPEURIDIUM});
                });

        private static final int[] BASE_DURABILITY = new int[]{598, 694, 701, 543};
